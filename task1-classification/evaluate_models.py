# This file contains WordVec, Naive Bayes, Binary Naive Bayes and Logistic regression.
# The models have been used to make predictions for the task1 - predicting spoilerType

# Run the file as -- python3 evaluate_models.py
